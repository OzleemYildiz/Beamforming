...
number_of_test_freq_GT_hwang_nocomingback = zeros(length(m), length(n));
trial = 100;
...
%             number_of_test_freq_Hwang_2seperate(j,i) = number_of_test_freq_Hwang_2seperate(j,i) + n_steps;
             ...
             [beam_loc, n_steps] = freq_GT_hwang_nocomingback(n(i),m(j), 1:n(i), {}, location, 0);
             number_of_test_freq_GT_hwang_nocomingback(j,i) = number_of_test_freq_GT_hwang_nocomingback(j,i) + n_steps;
...
number_of_test_freq_GT_hwang_nocomingback = number_of_test_freq_GT_hwang_nocomingback./trial;
...
save('number_of_test_freq_GT_hwang_nocomingback', 'number_of_test_freq_GT_hwang_nocomingback')
