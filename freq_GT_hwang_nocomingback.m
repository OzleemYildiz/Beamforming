...
function [beam_loc, n_steps] = freq_GT_hwang_nocomingback(n,m, valid_loc, beam_loc, location, n_steps)
%     if n == m
    ...
    if n <= 2*m-2
       ...
       if size >=n
        ...
        if size == 1 
            ...
            [beam_loc, n_steps] = freq_GT_hwang_nocomingback(n,m, valid_loc, beam_loc, location, n_steps); 
        ...
        elseif check1 == 0 && check2 == 0 && size~=1 % Both side has 1
            ...
            [beam_loc, test_n2, n,m, valid_loc_2] = binary_split(n, m, location, valid_loc(size+1:min(2*size,end)),hold, beam_loc, 0);
        ...
        elseif check1 && check2 == 0 && size~=1 % Second one has ACK
            [beam_loc, test_n2, n,m, valid_loc_2] = binary_split(n, m, location, valid_loc(1:hold),hold, beam_loc, 0);
            ...
            if hold_2 ~= 0
                ...
                if check_in == 1 %NACK
                    ...
                    [beam_loc, test_n_in, n,m, valid_loc_in] = binary_split(n, m, location, valid_loc(hold +1:hold +hold_2),hold_2, beam_loc, 0);
        ...
        elseif check1 == 0 && check2  && size~=1 % First one has ACK
            [beam_loc, test_n2, n,m, valid_loc_2] = binary_split(n, m, location, valid_loc(1:size),size, beam_loc, 0);
            ...
            if hold_2 ~= 0
                ...
                if check_in == 1 %NACK
                    ...
                    [beam_loc, test_n_in, n,m, valid_loc_in] = binary_split(n, m, location, valid_loc(size+1:size+hold_2),hold_2, beam_loc, 0);
