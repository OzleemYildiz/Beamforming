...
%            end
       ...
       if size_check >=n
        ...
        pathexists_2 = beamform_hierarchical(total_codebook,n, valid_loc(size_check+1: size_check+hold), gain_gaussian, angle_ue, threshold);
        ...
        elseif pathexists_1==0 && pathexists_2 && size_check~=1 % Second one has ACK
            ...
            if hold_2 ~= 0
                ...
                pathexists_in = beamform_hierarchical(total_codebook,n, valid_loc(hold +1:hold +hold_2), gain_gaussian, angle_ue, threshold);
                ...
                if pathexists_in==0 %NACK
                 ...
                 if isempty(valid_loc(hold+1+hold_2:end))==0 %Not empty so let me check
                    ...
                    pathexists_more = beamform_hierarchical(total_codebook,n, valid_loc(hold+1+hold_2:end), gain_gaussian, angle_ue, threshold);
        ...
        elseif pathexists_1 && pathexists_2==0  && size_check~=1 % First one has ACK
            ...
            if hold_2 ~= 0
                ...
                pathexists_in = beamform_hierarchical(total_codebook,n, valid_loc(size_check+1:size_check+hold_2), gain_gaussian, angle_ue, threshold);
                ...
                if pathexists_in==0 %NACK
                    ...
                    if isempty(valid_loc(size_check+1+hold_2:end))==0 %Not empty so let me check
                        ...
                        pathexists_more = beamform_hierarchical(total_codebook,n, valid_loc(size_check+1+hold_2:end), gain_gaussian, angle_ue, threshold);
